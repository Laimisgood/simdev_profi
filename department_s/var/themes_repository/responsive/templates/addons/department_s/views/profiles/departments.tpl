                        ...
                        {if $department}
                            ...
                            <div class="ty-grid-list__item ty-quick-view-button__wrapper">
                                ...
                                <div class="ty-grid-list__item-name">
                                    <bdi>
                                        <a href="{"profiles.department?department_id={$department.department_id}"|fn_url}"
                                            class="product-title" title="{$department.name}">{$department.name}</a>
                                    </bdi>
                                </div>
                                <div class="ty-grid-list__item-name">
                                    <bdi>
                                        <span>{__("departments.lead_name")}: </span> 
                                        <span>   
                                            {if !empty($department['lead_id'])}
                                                {$lead_user = fn_get_user_name($department['lead_id'])}
                                                {$lead_user}
                                            {/if}
                                        </span>
                                    </bdi>
